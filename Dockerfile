...
# quantize
RUN make quantize
RUN ./quantize models/ggml-tiny.en.bin models/ggml-tiny-q5_0.bin q5_0
RUN rm -rf models/ggml-tiny.en.bin
RUN make server
...
CMD ["./server", "-m", "./models/ggml-tiny-q5_0.bin", "-p", "8", "--host", "0.0.0.0", "--port", "8085", "--convert"]